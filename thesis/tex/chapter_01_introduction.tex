...
In recent years, we have seen a shift in the music industry towards more "vintage" or "old-school" sound. Musicians and producers seek analog equipment to add a unique flavor to their sound. With a rising demand, the price of this equipment inevitably goes up, not to mention the low availability of certain devices. Some of them are even no longer manufactured.
...
This work is organized as follows. Part I contains the theoretic foundations of the presented research. In \Chapter{chapter:odes_and_dl}, the basics of \acp{ODE} and deep learning are presented. As these areas are vast, only the most important aspects are explained with references pointing the reader to the relevant literature. In \Chapter{chapter:virtual_analog_modeling}, a short introduction to the research field of \ac{VA} modeling is followed by a detailed description of the diode clipper circuit and the phaser effect. Part II of the thesis with \Chapter{chapter:experiments} contains the actual experiments with diode clipper and phaser modeling, their results and discussion. The main focus is on the applicability of the \ac{ODE}-inspired deep learning approach to analog systems modeling as well as its possible advantages over other methods. Finally, \Chapter{chapter:conclusions} lists all the conclusions and indicates possible future work.
