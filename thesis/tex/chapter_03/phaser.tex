...
Test results of phaser modeling are contained in \Table{tab:phaser_results}. The 'Loss' is the \ac{ESR}-based loss from \Equation{eq:final_loss_function}. \ac{segSNR} was defined in \Equation{eq:seg_snr}. %TODO: + PEAQ...
