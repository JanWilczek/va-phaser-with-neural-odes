...
\usepackage{fix-cm}
\makeatletter 
\newcommand\semiHuge{\@setfontsize\semiHuge{16}{21}}
\makeatother
...
\newcommand{\Equations}[2]{Eqs.~\eqref{#1} and~\eqref{#2}}
\newcommand{\Equationst}[3]{Eqs.~\eqref{#1},~\eqref{#2} and~\eqref{#3}}
\newcommand{\EquationRange}[2]{Eqs.~\eqref{#1}-\eqref{#2}}
