...
CUDA_VISIBLE_DEVICES=0 python diode_clipper/diode_benchmark.py odenet forward_euler --batch_size 256 --init_len 0 --up_fr 22050 --val_chunk 22050 --test_chunk 22050 --epochs 10 --learn_rate 0.001 --name ODENet2
...
CUDA_VISIBLE_DEVICES=1 python diode_clipper/main.py ResIntRK4 --batch_size 512 --pre_filter --init_len 0 --epochs 1000 --learn_rate 0.001 --one_cycle_lr 0.02 --up_fr 1024 --val_chunk 22050 --test_chunk 0
