...
CUDA_VISIBLE_DEVICES=1 python diode_clipper/main.py --method STN --batch_size 256 --init_len 0 --up_fr 22050 --val_chunk 22050 --test_chunk 0 --epochs 141 --learn_rate 0.001 --teacher_forcing bernoulli --name Test192kHz --checkpoint May20_07-33-56_axel --test_sampling_rate 192000
