...
CUDA_VISIBLE_DEVICES=1 python diode_clipper/diode_benchmark.py ResIntRK4 --batch_size 512 --init_len 0 --up_fr 1024 --val_chunk 22050 --test_chunk 22050 --epochs 500 --learn_rate 0.001 --one_cycle_lr 0.01 --name ResIntRK4_onecycle
