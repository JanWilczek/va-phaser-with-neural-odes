...
CUDA_VISIBLE_DEVICES=1 python diode_clipper/diode_benchmark.py odenet implicit_adams --batch_size $BATCH_SIZE --init_len 0 --up_fr 22050 --val_chunk 22050 --test_chunk 22050 --epochs $EPOCHS --learn_rate 0.0005
