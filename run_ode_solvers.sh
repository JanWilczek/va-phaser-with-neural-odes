...
python diode_clipper/diode_ode_numerical.py --method-name BDF --upsample-factor 1 --length-seconds $LENGTH --input-scaling-factor $INPUT_SCALING_FACTOR --frame-length $FRAME_LENGTH $NORMALIZE
