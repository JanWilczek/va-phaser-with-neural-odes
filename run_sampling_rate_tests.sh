...
do
    ...
    # python diode_clipper/main.py --method ResIntRK4 --hidden_size 6 --epochs 600 --batch_size 512 --learn_rate 0.001 --one_cycle_lr 0.02 --init_len 0 --up_fr 1024 --val_chunk 22050 --test_chunk 0 --dataset_name diodeclip --checkpoint July06_12-52-13_axelFinalLossFunctionStep1  --test_sampling_rate $SAMPLING_RATE --name Test$SAMPLING_RATE

    python diode_clipper/main.py --method STN --batch_size 256 --epochs 140 --up_fr 22050 --val_chunk 22050 --test_chunk 0 --learn_rate 0.001 --teacher_forcing bernoulli --dataset_name diodeclip --checkpoint May20_07-33-56_axel  --test_sampling_rate $SAMPLING_RATE --name Test$SAMPLING_RATE
done
