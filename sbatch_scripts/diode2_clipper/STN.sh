...
srun python diode2_clipper/main.py --method STN --layers_description "3x${HIDDEN_SIZE}x2" --epochs 20 --batch_size 25 --up_fr 100 --val_chunk 22050 --test_chunk 0 --learn_rate 0.0005 --teacher_forcing always --dataset_name diode2clip --validate_every 10 --loss_function ESRLoss --nonlinearity Tanh --name Hidden$HIDDEN_SIZE --checkpoint alec_dc2
