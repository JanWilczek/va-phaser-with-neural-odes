...
srun python diode2_clipper/main.py --method STN --layers_description "3x${HIDDEN_SIZE}x${HIDDEN_SIZE}x2" --epochs 1200 --batch_size 25 --up_fr 100 --val_chunk 22050 --test_chunk 0 --learn_rate 0.000000005 --teacher_forcing bernoulli --dataset_name diode2clip --validate_every 10 --loss_function ESRLoss --nonlinearity Tanh --name Hidden$HIDDEN_SIZE --checkpoint November28_21-44-40_gpu20.int.triton.aalto.fi_Hidden30
