...
#--------------------------------------------------------
CUDA_VISIBLE_DEVICES=1 python phaser/main.py --method ScaledODENetFE --batch_size 256 --up_fr 2048 --val_chunk 22050 --test_chunk 0 --epochs 1200 --learn_rate 0.1 --exponential_lr 0.001 --teacher_forcing always --dataset_name FameSweetToneOffNoFb --hidden_size 30 --validate_every 10 --loss_function log_spectral_distance --nonlinearity SELU --derivative_network DerivativeMLPFE
