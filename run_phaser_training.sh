...
CUDA_VISIBLE_DEVICES=1 python phaser/main.py --method odeint_implicit_adams --batch_size 128 --up_fr 2048 --val_chunk 22050 --test_chunk 0 --epochs 300 --learn_rate 0.001 --one_cycle_lr 0.01 --teacher_forcing always --weight_decay 0.00001 --dataset_name FameSweetToneOffNoFb --hidden_size 50 --nonlinearity SELU --validate_every 5
