...
CUDA_VISIBLE_DEVICES=0 python phaser/main.py --method forward_euler --batch_size 256 --up_fr 2048 --val_chunk 22050 --test_chunk 0 --epochs 1200 --learn_rate 0.2 --exponential_lr 0.05 --teacher_forcing bernoulli --dataset_name FameSweetToneOffNoFb --state_size 18 --hidden_size 40 --nonlinearity Softsign --validate_every 10 --loss_function log_spectral_distance --derivative_network DerivativeMLP
